...
- **Naming a deepened module after a concept not in `CONTEXT.md`?** Add the term to `CONTEXT.md` — same discipline as `/clarify-specs-w-domain-awareness` (see [CONTEXT-FORMAT.md](../clarify-specs-w-domain-awareness/CONTEXT-FORMAT.md)). Create the file lazily if it doesn't exist.
